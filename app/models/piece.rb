class Piece < ApplicationRecord
  ...
  def obstructed?(destination_x, destination_y)
    destination_tests = [horizontal_obstruction?(destination_x, destination_y), vertically_obstruction?(destination_x, destination_y), diagonal_one_obstruction?(destination_x, destination_y), diagonal_two_obstruction?(destination_x, destination_y)]
    return true if destination_tests.include?(true)
    return 'Error: Invalid Input'  if invalid_input?(destination_tests, destination_x, destination_y)
    false
  end

  def invalid_input?(destination_tests, destination_x, destination_y)
  ...
  def vertically_obstruction?(destination_x, destination_y)
  ...
  def diagonal_one_obstruction?(destination_x, destination_y) # up_right_down_left diagonal  /
  ...
  def diagonal_two_obstruction?(destination_x, destination_y) # up_left_down_right diagonal \
